...
export default async function BlogCategoryPage(props: {
  ...
  const schemaData = {
    ...
    '@type': 'Blog',
    'name': `Neuro IT Blog — ${category.name}`,
    'description': `Expert computer repair guides and IT steps focusing on ${category.name} in London.`,
    'publisher': {
      '@type': 'LocalBusiness',
      'name': 'Neuro IT',
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <h1 className="font-syne" style={{ color: 'var(--text-primary)', fontWeight: 800, fontSize: '3rem', marginBottom: '1.25rem', letterSpacing: '-0.02em' }}>
              Category: <span style={{ color: '#00D2FF' }}>{category.name}</span>
            </h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
              Browse all published articles, tutorials and tech guides related to {category.name}.
            </p>
          </div>
